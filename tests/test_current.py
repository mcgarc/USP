...
class TestRampCurrent(unittest.TestCase):
    ...
    def test_current_simple(self):
        ...
        self.assertAlmostEqual(self.ramp.current(2.9), 0.1)
    ...
    def test_current_two_stage(self):
        ...
        self.assertAlmostEqual(ramp.current(2.5), 1.5)
        self.assertAlmostEqual(ramp.current(2.9), 1.9)
        self.assertEqual(ramp.current(3), 2)
        self.assertEqual(ramp.current(3.8), 2)
        self.assertEqual(ramp.current(4), 2)
        self.assertAlmostEqual(ramp.current(4.1), 1.8)
        self.assertAlmostEqual(ramp.current(4.5), 1)
