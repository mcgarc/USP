...
from current import AbstractCurrentProfile
import utils
...
class WireSegment:
    ...
    def set_current(self, current):
        if not isinstance(current, AbstractCurrentProfile):
            warn = 'Current must inherit from current.AbstractCurrentProfile'
    ...
    def field(self, t, r):
        ...
        current = self.current.current(t)
